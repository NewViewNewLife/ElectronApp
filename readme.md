...
![Electron-builder修改后的package.json文件(Electron-builder修改后的package.json文件.png)](https://github.com/NewViewNewLife/ElectronApp/blob/main/imgs/Electron-builder修改后的package.json文件.png.png)
...
正确的打包结果如下：
![正确的打包结果(正确的打包结果.png)](https://github.com/NewViewNewLife/ElectronApp/blob/main/imgs/正确的打包结果.png)

打包时的报错信息（指出了下载失败的文件及下载地址）：
![错误的打包结果(错误的打包结果.png)](https://github.com/NewViewNewLife/ElectronApp/blob/main/imgs/错误的打包结果.png)
